...
@section('body')
    <div class="table-div">
        <a class="btn btn-default btn-sm hor-align pull-right btn-right-spacing" href="{{route('usergroup.create')}}" ><i class='glyphicon glyphicon-plus-sign'></i>&nbsp;&nbsp;New</a>
...
<script>
    $('document').ready(function(){
        ...
        var column = [
            ...
            {
                return '<input id="'+data+'" class="check_class" type="checkbox" value='+row["id"]+' name="selected_groups[]"><label for="'+data+'"><span></span></label>';
            }
            },
            ...
            { data: 'status', name: 'usergroup.status', sortable: false , className: 'textcenter' },
