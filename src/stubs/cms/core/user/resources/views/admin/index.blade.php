...
@section('body')
    <div class="table-div">
        <a class="btn btn-default btn-sm hor-align pull-right btn-right-spacing" href="{{route('user.create')}}" ><i class='glyphicon glyphicon-plus-sign'></i>&nbsp;&nbsp;New</a>
...
<script>
    $('document').ready(function(){
        ...
        var column = [
            ...
            { data: 'group', name: 'group' , className: 'textcenter' },
