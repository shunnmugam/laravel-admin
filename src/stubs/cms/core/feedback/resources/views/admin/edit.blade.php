...
@section('body')
    <div class="x_content">
        ...
        @if($layout == "create")
            {{ Form::open(array('role' => 'form', 'route'=>array('feedback.store'), 'method' => 'post', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal form-label-left', 'id' => 'user-form','novalidate' => 'novalidate')) }}
        @elseif($layout == "edit")
            {{ Form::open(array('role' => 'form', 'route'=>array('feedback.update',$data->id), 'method' => 'put', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal form-label-left', 'id' => 'user-form','novalidate' => 'novalidate')) }}
        @endif
            <div class="box-header with-border mar-bottom20">
                ...
                <a class="btn btn-default btn-sm pull-right btn-right-spacing" href="{{route('feedback.index')}}" ><i class="glyphicon glyphicon-arrow-left"></i>&nbsp;&nbsp;&nbsp;Back</a>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    {{Form::textarea('message',@$data->message,array('id'=>"number",'class'=>"form-control col-md-7 col-xs-12" ,
