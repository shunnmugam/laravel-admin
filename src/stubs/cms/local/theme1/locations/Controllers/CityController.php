...
class CityController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('locations::admin.city.edit',['layout'=>'edit','data'=>$obj,
            'countries'=>$countries,
    ...
    public function getData(Request $request) {
        ...
        $data = CitiesModel::select(DB::raw('@rownum  := @rownum  + 1 AS rownum'),"cities.id as id","cities.name as name","countries.name as country_name","states.name as state_name",
